...
A magnifier beside each block's grip, on hover. A press zooms in: back, reset and the block's
...
- `src/webview/components/editor/editor-kit.tsx` — the kit, after `DndKit`
